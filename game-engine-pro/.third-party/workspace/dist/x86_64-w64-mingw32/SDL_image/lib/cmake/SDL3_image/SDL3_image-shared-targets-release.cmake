...
set_target_properties(SDL3_image::dav1d PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libdav1d.dll"
  )

list(APPEND _cmake_import_check_targets SDL3_image::dav1d )
list(APPEND _cmake_import_check_files_for_SDL3_image::dav1d "${_IMPORT_PREFIX}/bin/libdav1d.dll" )
...
set_target_properties(SDL3_image::aom PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libaom.dll"
  )

list(APPEND _cmake_import_check_targets SDL3_image::aom )
list(APPEND _cmake_import_check_files_for_SDL3_image::aom "${_IMPORT_PREFIX}/bin/libaom.dll" )
...
set_target_properties(SDL3_image::external_libtiff PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libtiff.dll"
  )

list(APPEND _cmake_import_check_targets SDL3_image::external_libtiff )
list(APPEND _cmake_import_check_files_for_SDL3_image::external_libtiff "${_IMPORT_PREFIX}/bin/libtiff.dll" )
