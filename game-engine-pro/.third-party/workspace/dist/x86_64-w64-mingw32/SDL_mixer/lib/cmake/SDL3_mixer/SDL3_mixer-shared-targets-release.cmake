...
list(APPEND _cmake_import_check_files_for_SDL3_mixer::ogg "${_IMPORT_PREFIX}/bin/libogg-0.dll" )
...
set_target_properties(SDL3_mixer::opus PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libopus-0.dll"
  )

list(APPEND _cmake_import_check_targets SDL3_mixer::opus )
list(APPEND _cmake_import_check_files_for_SDL3_mixer::opus "${_IMPORT_PREFIX}/bin/libopus-0.dll" )
...
set_target_properties(SDL3_mixer::opusfile PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libopusfile-0.dll"
  )

list(APPEND _cmake_import_check_targets SDL3_mixer::opusfile )
list(APPEND _cmake_import_check_files_for_SDL3_mixer::opusfile "${_IMPORT_PREFIX}/bin/libopusfile-0.dll" )
...
set_target_properties(SDL3_mixer::vorbis PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libvorbis-0.dll"
  )

list(APPEND _cmake_import_check_targets SDL3_mixer::vorbis )
list(APPEND _cmake_import_check_files_for_SDL3_mixer::vorbis "${_IMPORT_PREFIX}/bin/libvorbis-0.dll" )
...
set_target_properties(SDL3_mixer::vorbisfile PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libvorbisfile-3.dll"
  )

list(APPEND _cmake_import_check_targets SDL3_mixer::vorbisfile )
list(APPEND _cmake_import_check_files_for_SDL3_mixer::vorbisfile "${_IMPORT_PREFIX}/bin/libvorbisfile-3.dll" )
...
set_target_properties(SDL3_mixer::FLAC PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libFLAC-8.dll"
  )

list(APPEND _cmake_import_check_targets SDL3_mixer::FLAC )
list(APPEND _cmake_import_check_files_for_SDL3_mixer::FLAC "${_IMPORT_PREFIX}/bin/libFLAC-8.dll" )
...
set_target_properties(SDL3_mixer::gme_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libgme.dll"
  )

list(APPEND _cmake_import_check_targets SDL3_mixer::gme_shared )
list(APPEND _cmake_import_check_files_for_SDL3_mixer::gme_shared "${_IMPORT_PREFIX}/bin/libgme.dll" )
...
set_target_properties(SDL3_mixer::libmpg123 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libmpg123-0.dll"
  )

list(APPEND _cmake_import_check_targets SDL3_mixer::libmpg123 )
list(APPEND _cmake_import_check_files_for_SDL3_mixer::libmpg123 "${_IMPORT_PREFIX}/bin/libmpg123-0.dll" )
